const hero = () => {
  return (
    <div className="h-96">
        <div className="bg-[url(background.jpg)] bg-cover bg-center bg-fixed h-96 px-24 py-10">
            <div className="flex h-[80%]">    
                <div className="w-1/2"></div>
                <div className="w-1/2">
                    <h1 className="text-end text-white font-bold text-5xl"> PEMIRA 2025 </h1>
                    <p className="text-end text-white mt-5 text-xl">Pilihan mu menentukan masa depan organisasi XYZBCA <br /> #BijakMemilih #JanganGolput</p>
                </div>
            </div>
